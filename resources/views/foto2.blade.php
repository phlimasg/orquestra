    ...
    <div class="container-fluid photos">
      <div class="row align-items-stretch"> 
        ...
        <div class="col-6 col-md-6 col-lg-{{$col[rand(0,2)]}}" data-aos="fade-up">
          <a href="{{asset('images/album/making_off/'.$i.'.jpg')}}" class="d-block photo-item" data-fancybox="gallery">
            <img src="{{asset('images/album/making_off/'.$i.'.jpg')}}" alt="Image" class="img-fluid">
